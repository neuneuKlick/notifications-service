...
public class PostComment implements KafkaHandler {

    final private NotificationSettingRepository settingRepository;
    ...
    public List<Notification> getNotificationFromKafkaConsumer(NotificationDto dto) {
        ...
        if (notificationSetting.getEnablePostComment()) {
